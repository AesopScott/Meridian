...
def make_default_map() -> FileMap:
    ...
    entries = [
        ...
        FileMapEntry(
            ...
            area=FileArea.PRIME_AUTONOMY,
            purpose="Prime runtime decision contract: assembles Compass, Vulcan, Relay, and Aegis risk source refs into one visible PrimeDecision with owner resolution, executability gates, proof packet, and bridge snapshot.",
            related_tests=["tests/test_prime_runtime.py", "tests/test_bifrost_cockpit.py"],
            notes="Bifrost consumes this through /bridge/prime-logic; Aegis aggregate gate summaries feed PrimeAegisRiskInput. Keep visible Prime harness logic backend-sourced.",
        ),
        FileMapEntry(
