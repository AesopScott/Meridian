...
def make_default_map() -> FileMap:
    ...
    entries = [
        ...
        FileMapEntry(
            ...
            area=FileArea.BIFROST,
            purpose="Explicit authority note: index.html is the actual Meridian UI, Electron wraps it, and bifrost/preview.html is only generated proof output.",
            related_tests=["tests/test_filemap.py"],
        ...
        FileMapEntry(
            path="index.html",
            area=FileArea.BIFROST,
            purpose="Actual Meridian UI and product cockpit surface: renders the harness dock, Prime panel, user/session panel, Spark center, right-panel modes, model bridge status, and backend-sourced Prime/Relay/Compass/Vulcan logic surfaces.",
            related_tests=["tests/test_relay_logic_snapshot.py", "tests/test_bifrost_cockpit.py", "tests/test_bifrost_preview.py"],
            notes="Root UI authority. Electron opens this file via electron/main.js; do not replace it with bifrost/preview.html for demos or app startup.",
        ),
        FileMapEntry(
        ...
        FileMapEntry(
            ...
            area=FileArea.BIFROST,
            purpose="Meridian Electron main process: creates the desktop window and loads the actual root index.html UI with secure defaults.",
        ...
        FileMapEntry(
            ...
            notes="Generated by bifrost/preview.py; not the actual Meridian UI and not the Electron app target.",
        ),
        FileMapEntry(
            path="tests/test_bifrost_preview.py",
            area=FileArea.BIFROST,
            purpose="Test suite for bifrost/preview.py and Electron launch wiring: keeps generated preview behavior separate from the actual index.html UI startup path.",
            related_tests=[],
