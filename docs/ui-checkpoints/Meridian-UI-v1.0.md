...
Meridian UI. This checkpoint records an earlier named UI state and should not
be treated as the current app entrypoint unless intentionally restoring that
old visual state.
